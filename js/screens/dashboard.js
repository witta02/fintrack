...
export function renderDashboard(container) {
  ...
  container.innerHTML = `
    ...
    <!-- Net Worth Card -->
    <div class="card net-worth-card" id="net-worth-card-clickable" style="padding: 16px; margin-top: 16px; margin-bottom: 20px; cursor: pointer; display: ${store.settings.showNetWorthCard !== false ? 'flex' : 'none'}; align-items: center; justify-content: space-between; background: linear-gradient(135deg, rgba(255, 184, 0, 0.05), var(--card)); border: 1px solid var(--border); border-radius: 16px; transition: all var(--transition);">
