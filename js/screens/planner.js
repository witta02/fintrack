...
export function renderPlanner(container) {
  renderedCount = 0; // Redraw entire message history cleanly
  ...
  container.innerHTML = `
    ...
    <div class="screen screen-enter chat-container" style="padding: 0 16px 80px;">
      <!-- Header -->
      <div class="chat-header" style="padding: 14px 0 12px; margin-bottom: 8px;">
