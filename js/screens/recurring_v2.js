...
function showAddRecurringModal() {
  ...
  function renderModalCategoryPicker() {
    ...
    `;
    addTile.innerHTML = `
      <div class="category-picker-icon" style="font-size: 20px; color: var(--text-secondary); display: flex; align-items: center; justify-content: center; width: 32px; height: 32px; background: var(--bg-secondary); border-radius: 10px; border: 1.5px dashed var(--border); transition: all 0.2s;">
      ...
      <div class="category-picker-label" style="font-size: 10.5px; font-weight: 500; color: var(--text-secondary); text-align: center; line-height: 1.1;">${t('add')}</div>
    `;
